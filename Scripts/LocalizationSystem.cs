...
public static class LocalizationSystem
{
    ...
    {
        LocalizationConfigLoader.LoadText("CN", "default");
        LocalizationConfigLoader.LoadSprite("CN", "default");
        LocalizationConfigLoader.LoadText("EN", "default");
        LocalizationConfigLoader.LoadSprite("EN", "default");
        LocalizationConfigLoader.LoadWithCode("CN", "kexiang");
        LocalizationConfigLoader.LoadWithCode("EN", "kexiang");
